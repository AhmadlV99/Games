-- Grow a Garden - WindUI Version (Full Script)
-- Converted by Celeste
...
mainTab:CreateToggle({
    Name = "Auto Collect",
    Default = _CH.candyhub.autocollect,
    Callback = function(v)
...
miscTab:CreateToggle({
    Name = "Auto DupeBuy Supers ($5-$35)",
    Default = _CH.candyhub.superdupe,
    Callback = function(v)
...
miscTab:CreateToggle({
    Name = "Auto Buy Selected Easter Seeds",
    Default = _CH.candyhub.easterautobuy,
    Callback = function(v)
...
-- === WIPE TAB ===
wipeTab:CreateButton({ Name = "Wipe All Plots", Callback = function()
...
wipeTab:CreateButton({ Name = "Wipe Inventory", Callback = function()
